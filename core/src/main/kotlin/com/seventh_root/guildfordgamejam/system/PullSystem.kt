...
class PullSystem: IteratingSystem(Family.all(PlayerComponent::class.java, PositionComponent::class.java, VelocityComponent::class.java, GravityComponent::class.java).get()) {
    ...
    override fun processEntity(entity: Entity, deltaTime: Float) {
        ...
        if (closestGrapple != null) {
            gravity.get(entity).targetX = position.get(closestGrapple).x
            gravity.get(entity).targetY = position.get(closestGrapple).y
        }
    }
}